...
export const commonZh = {
  ...
  subtitleEdit: {
    ...
    marginR: '右边距',
    encoder: '编码器',
    composing: '正在合成字幕... {percent}%',
    composeDone: '字幕合成完成！',
    downloadVideo: '下载视频',
    fullscreen: '全屏预览',
    refreshPreview: '刷新预览',
    maxCharsPerLine: '每行字数',
    auto: '自动'
  },
  setting: {
    title: '设置',
...
export const commonEn = {
  ...
  subtitleEdit: {
    ...
    emptyClip: '(empty)',
    emptySubtitle: 'No subtitles yet, click "Add Subtitle" to create',
    ...
    marginR: 'Margin R',
    encoder: 'Encoder',
    composing: 'Burning subtitles... {percent}%',
    composeDone: 'Subtitle composition complete!',
    downloadVideo: 'Download Video',
    fullscreen: 'Fullscreen',
    refreshPreview: 'Refresh Preview',
    maxCharsPerLine: 'Max Chars',
    auto: 'Auto'
  },
  setting: {
    title: 'Setting',
